        ...
        <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
          ...
          <Marquee pauseOnHover className="[--duration:30s] mb-3">
            ...
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              ...
              <span className="text-black font-semibold">Java</span>
            </div>
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              ...
              <span className="text-black font-semibold">PHP</span>
            </div>
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              <img src="https://svgl.app/library/dart.svg" alt="Dart" className="w-6 h-6" />
              <span className="text-black font-semibold">Dart</span>
            </div>
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              <img src="https://svgl.app/library/powershell.svg" alt="PowerShell" className="w-6 h-6" />
              <span className="text-black font-semibold">PowerShell</span>
            </div>
          </Marquee>
          ...
          <Marquee reverse pauseOnHover className="[--duration:35s] mb-3">
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              ...
              <span className="text-black font-semibold">HTML5</span>
            </div>
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              <img src="https://svgl.app/library/css.svg" alt="CSS" className="w-6 h-6" />
              <span className="text-black font-semibold">CSS</span>
            </div>
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              ...
              <span className="text-black font-semibold">Bootstrap</span>
            </div>
          </Marquee>
          ...
          <Marquee reverse pauseOnHover className="[--duration:32s] mb-3">
            ...
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              ...
              <span className="text-black font-semibold">GitHub Copilot</span>
            </div>
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              <img src="https://svgl.app/library/claude-ai-icon.svg" alt="Claude AI" className="w-6 h-6" />
              <span className="text-black font-semibold">Claude AI</span>
            </div>
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              ...
              <span className="text-black font-semibold">OpenAI</span>
            </div>
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              ...
              <span className="text-black font-semibold">Grok AI</span>
            </div>
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              <img src="https://svgl.app/library/groq.svg" alt="Groq" className="w-6 h-6" />
              <span className="text-black font-semibold">Groq</span>
            </div>
            <div className="mx-3 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              <img src="https://svgl.app/library/gemini.svg" alt="Gemini" className="w-6 h-6" />
              <span className="text-black font-semibold">Gemini</span>
            </div>
          </Marquee>
